...
*   **Editor Shortcuts:** Outside Splore, show ESC, Tab, Code, Sprite, Map, SFX, and Music controls in a two-row 5×2 grid beneath MENU. The controls enter PICO-8's native editor when needed and activate its corresponding built-in toolbar tab; they remain available while editing and hide only in Splore.

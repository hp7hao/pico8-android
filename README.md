...
*   **Editor Shortcuts:** Outside Splore, show ESC, Code, Sprite, Map, SFX, and Music controls beneath MENU. The controls enter PICO-8's native editor when needed and activate its corresponding built-in toolbar tab; they remain available while editing and hide only in Splore.
